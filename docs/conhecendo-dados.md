...
Os dados avaliadoa no _dataset_ são apresentados na próxima seção. os gráficos expressam os dados maia recorrentes, as correlações de variáveis, os achados e insights obtidos durante as análises.
